...
In order to obtain the Client ID and Client Secret, it's necessary for you to register your application with the API provider. It's also important to register the required scopes with both the API provider and on the OAuth page.
