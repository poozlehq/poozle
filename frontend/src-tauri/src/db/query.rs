...
pub fn commands_list(conn: &SqliteConnection) -> String {
...
pub fn create_command(conn: &SqliteConnection, new_command: NewCommand) -> String {
...
pub fn create_spec(conn: &SqliteConnection, new_spec: NewSpec) -> String {
...
pub fn get_spec(conn: &SqliteConnection, ext_id: &str) -> Result<Spec, String> {
